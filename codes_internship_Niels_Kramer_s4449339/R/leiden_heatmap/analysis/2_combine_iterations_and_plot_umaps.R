...
file1 <- "R/leiden_heatmap/clean_data/next_step/TMM_normalised_weighed_clusters_after_1000_repeats_of_leiden_filtered_1.csv"
file2 <- "R/leiden_heatmap/clean_data/next_step/TMM_normalised_weighed_clusters_after_1000_repeats_of_leiden_filtered_2.csv"
file3 <- "R/leiden_heatmap/clean_data/next_step/TMM_normalised_weighed_clusters_after_1000_repeats_of_leiden_filtered_3.csv"
file4 <- "R/leiden_heatmap/clean_data/next_step/TMM_normalised_weighed_clusters_after_1000_repeats_of_leiden_filtered_4.csv"
file5 <- "R/leiden_heatmap/clean_data/next_step/TMM_normalised_weighed_clusters_after_1000_repeats_of_leiden_filtered_5.csv"
