...
figure_dir <- paste(paste(getwd(),'/R/kernel_density_estimates/figures/',sep=""), Sys.Date(), sep="")
...
data_dir <- paste(paste(getwd(),'/R/kernel_density_estimates/clean_data/',sep=""), Sys.Date(), sep="")
